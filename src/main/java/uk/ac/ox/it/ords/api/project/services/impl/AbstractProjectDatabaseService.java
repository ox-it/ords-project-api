...
public abstract class AbstractProjectDatabaseService implements
		ProjectDatabaseService {

	@Override
	public void validate(Database database) throws ValidationException {
		//
		// Add any business rules here that aren't handled by bean validation within the Database class itself
		//
	}
