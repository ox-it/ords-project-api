...
public class SendProjectInvitationEmailServiceTest extends SendProjectInvitationEmailServiceImpl{
	...
	public void testLinkCreate(){
		...
		String link = this.getInvitationUrl(invite);
	...
	public void testMessageCreate(){
		...
		String messageText = this.createInvitationMessage(invite);
	...
	public void sendMailTest() throws Exception {
	    ...
	    new SendProjectInvitationEmailServiceImpl(props).sendProjectInvitation(invite);
